...
class RandomTestAbstractController extends AbstractAllocatorControllerTest
{
    public function testCreate()
    {
        ...
        $responsibleStoreData = $actualData[0]['responsible_stores'][0];
        $this->assertArrayHasKey('id', $responsibleStoreData);
        $expectedData[0]['responsible_stores'][]['id'] = $responsibleStoreData['id'];
    ...
    public function expectedData(): array
    {
        return [
            [
                ...
                'delivery_count' => 1,
                'responsible_stores' => [
                    //will be added from a random sample
                ],
            ],
            [
                'product_id' => 3,
